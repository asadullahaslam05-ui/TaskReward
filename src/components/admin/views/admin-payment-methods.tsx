              ...
              <CardContent className="px-0 space-y-3">
                ...
                {m.qrCodeUrl && (
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
                    {/^https?:\/\//i.test(m.qrCodeUrl) ? (
                      // External public URL — safe to load directly.
                      <img
                        src={m.qrCodeUrl}
                        alt="QR code"
                      ...
                      // Storage path (typically in the public `site-assets`
                      // bucket). Render via the signed-image helper so it
                      // resolves correctly and surfaces load errors instead
                      // of silently hiding a broken image.
                      <div className="h-16 w-16 rounded border bg-white overflow-hidden">
                        <SignedImage
                          path={m.qrCodeUrl}
                          bucket="site-assets"
                          alt="QR code"
