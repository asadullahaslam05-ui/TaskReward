...
export function AdminTaskSubmissions() {
  ...
  const openAction = (submission: Submission, action: "APPROVED" | "REJECTED" | "FLAGGED") => {
  ...
  const submitAction = () => {
    ...
    if (actionDialog.action !== "APPROVED" && !adminNote.trim()) {
  ...
  const actionColor = actionDialog?.action === "APPROVED"
    ...
    <div className="space-y-6">
                      ...
                      {sub.status === "PENDING" && (
                        <>
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            onClick={() => openAction(sub, "FLAGGED")}
              ...
              {viewSubmission.status === "PENDING" && (
                <div className="flex flex-wrap gap-2 pt-2 border-t">
                  <Button
                    ...
                    onClick={() => openAction(viewSubmission, "APPROVED")}
                  ...
                  <Button
                    ...
                    onClick={() => openAction(viewSubmission, "REJECTED")}
                    disabled={actionMutation.isPending}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => openAction(viewSubmission, "FLAGGED")}
                    disabled={actionMutation.isPending}
                  >
      ...
      <Dialog open={!!actionDialog} onOpenChange={(o) => !o && setActionDialog(null)}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {actionDialog?.action === "APPROVED" && "Approve Submission"}
              {actionDialog?.action === "REJECTED" && "Reject Submission"}
              {actionDialog?.action === "FLAGGED" && "Flag Submission"}
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-3">
            <div>
              <Label htmlFor="adminNote">
                Admin Note {actionDialog?.action !== "APPROVED" && <span className="text-red-500">*</span>}
              </Label>
              <Textarea
                id="adminNote"
                value={adminNote}
