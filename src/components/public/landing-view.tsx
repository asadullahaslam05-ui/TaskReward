...
export function LandingView() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: `Earn ${settings?.currencySymbol || "Rs"} ${settings?.referralReward || 50} for every friend you refer.`,
    },
    {
      icon: HeadphonesIcon,
      title: "24/7 Support",
  ...
  const steps = [
    { num: "1", title: "Register & Pay", desc: `Pay the one-time registration fee of ${settings?.currencySymbol || "Rs"} ${settings?.registrationFee || 500}.` },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ListChecks, label: "Tasks Completed", value: "500,000+" },
              { icon: Wallet, label: "Total Paid Out", value: `${settings?.currencySymbol || "Rs"} 5M+` },
              { icon: TrendingUp, label: "Avg. Daily Earnings", value: `${settings?.currencySymbol || "Rs"} 200+` },
            ].map((stat) => (
