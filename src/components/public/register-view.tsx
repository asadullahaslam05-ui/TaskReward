...
import { ArrowLeft, Loader2, User, Mail, Lock, Phone, AtSign, Gift, AlertTriangle } from "lucide-react";
...
export function RegisterView() {
  ...
  // Never fall back to a hardcoded amount (e.g. 500). If the configured fee is
  // missing or invalid, surface a clear configuration error instead of
  // silently displaying a wrong number.
